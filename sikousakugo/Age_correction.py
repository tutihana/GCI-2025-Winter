...
test = test.drop(columns=['Ticket', 'Cabin',"PassengerId","Name", 'Title'])
...
#今日の狙い
#Ageの欠損値補完のやり方を固定化しつつ、別モデルを使う。
#最初にやること→①Ageの補完方法を変更　②別モデルで検証してみる
#Ageからの変更点　Ageの補完をTitleごとの中央値で補完する方法に変更＋Fareコラムは戻した。　結果、検証データの正解率　0.8502 訓練データの正解率　0.8551
#